...
public class CompConfigs {
    ...
    public static Properties getPropBdAutoSystem( ) {
    ...
    public static String getUrlBdAutoSystem() {
        
        if (isTeste)
            return "jdbc:postgresql://192.168.254.1:5432/matriz";
        else
            return "jdbc:postgresql://192.168.254.1:5432/matriz";
    
    }
    
    public static Properties getPropBdEMSys() {
    ...
    public static String getUrlBdEMSys() {
        
        if (isTeste)
            return "jdbc:postgresql://192.168.254.15:5432/tst_redemime";
        else
            return " ";

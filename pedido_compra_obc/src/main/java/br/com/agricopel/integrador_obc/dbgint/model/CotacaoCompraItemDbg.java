...
public class CotacaoCompraItemDbg {
	...
	private CotacaoCompraDbg cotacaoCompraDbg;
	...
	public CotacaoCompraDbg getCotacaoCompraDbg() {
		return cotacaoCompraDbg;
	}

	public void setCotacaoCompraDbg(CotacaoCompraDbg cotacaoCompraDbg) {
		this.cotacaoCompraDbg = cotacaoCompraDbg;
	}

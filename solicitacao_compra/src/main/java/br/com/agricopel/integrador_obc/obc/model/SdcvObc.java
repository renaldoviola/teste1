...
public class SdcvObc {
	...
	private String planejador;
	private String fornecedorExclusivo;

	private String descProduto;
	private ObcRecConfEntidadeObc retornoProc;

	private List<SdcvRateioObc> rateios;
	...
	public ObcRecConfEntidadeObc getRetornoProc() {
		return retornoProc;
	}

	public void setRetornoProc(ObcRecConfEntidadeObc retornoProc) {
		this.retornoProc = retornoProc;
	}

	public List<SdcvRateioObc> getRateios() {
		return rateios;
	}
	...
	public String getFornecedorExclusivo() {
		return fornecedorExclusivo;
	}

	public void setFornecedorExclusivo(String fornecedorExclusivo) {
		this.fornecedorExclusivo = fornecedorExclusivo;
	}
